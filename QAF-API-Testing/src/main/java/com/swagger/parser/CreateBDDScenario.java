...
public class CreateBDDScenario {
	public static void createQmetryScenario() throws Exception {
		...
		for (int i = 1; i < rowCount; i++) {
			...
			String resDefName = bddScenario.getResponseFileName(swgFile, excelFilePath, method);
	...
	public String getResponseFileName(String swgFilePath, String excelsheetPath, String method) throws Exception {
			...
			if (httpMethod.equalsIgnoreCase("GET")) {
				...
				while (rspIt.hasNext()) {
					...
					if (b.equals("200")) {
						...
						if (rsp.getResponseSchema().getClass().getName()
								.equalsIgnoreCase("io.swagger.models.ArrayModel")) {
						...
						if (rsp.getResponseSchema().getClass().getName()
								.equalsIgnoreCase("io.swagger.models.RefModel")) {
